...
export const hexToId = (hex: string) => hex.replace(regexServiceChar, '');
...
export const unicodeToCodePoint = (unicode: string, separator = '-') => {
  const result = [];
  let pair = 0;
...
export const fromCodePoint = (codepoint: string) => {
...
export const codePointToUnicode = (hex: string) => (
